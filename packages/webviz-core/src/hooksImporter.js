...
export function panelsByCategory() {
  ...
  const GoalSelection = require("webviz-core/src/panels/GoalSelection").default;
  const LinearAcceleration = require("webviz-core/src/panels/LinearAcceleration").default;
  const LinearVelocity = require("webviz-core/src/panels/LinearVelocity").default;
  const TimeDisplay = require("webviz-core/src/panels/TimeDisplay").default;

  const adeye = [
    { title: "Linear Velocity", component: LinearVelocity },
    { title: "Linear Acceleration", component: LinearAcceleration },
    { title: "Goal Selection", component: GoalSelection },
    { title: "Time Display", component: TimeDisplay},
  ];
  ...
  return { adeye, ros, utilities, debugging };
}
