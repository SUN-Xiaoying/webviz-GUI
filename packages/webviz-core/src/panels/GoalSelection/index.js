...
function GoalSelection({ config, saveConfig }: Props) {
...
GoalSelection.panelType = "GoalSelection";
GoalSelection.defaultConfig = { noteText: "" };

export default hot(Panel<Config>(GoalSelection));
